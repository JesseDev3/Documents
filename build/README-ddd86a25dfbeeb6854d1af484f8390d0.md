...
- Enterprise architecture and platform planning
- Technical and operational documentation
- Research, engineering, and data-related enablement
...
- Cloud, platform, and DevOps architecture
- Security, governance, and compliance references
- Research domains and domain-specific knowledge bases
- Engineering, mathematics, robotics, biomedical, aerospace, and advanced technology areas
...
This visualization is intended to enable:

- A clear view of how internal capabilities and domains relate to each other
- Drill-down exploration across organizational or technical categories
