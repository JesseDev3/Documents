...
[Green Light Excitation in Optogenetics](01_guide/getting_started.md)
...
9. Her: "I would like to [Reduce his amount of access](https://google.com)", "A wildcard".
    ...
    - Also before this I stated that it doesn't matter what channel you are on. See: [CTSS](), [frequency hopping](), [baofeng]() (8 levels?).
...
11. Him: "[Lets make it deep.](https://ophelialabs.github.io/jb./index3/#id-2-implementation-of-shallow-mode-in-go-nesd)"
    ...
    - You will now note the absence of the AI and its lack of response when called, overlays
       ...
       *  Also note that with certain access, things such as Workday job submitions can be approved or rejected using the xlsx method (if you can catch it before it hits approval from all parties, i.e. - immediate supervisor, corporate sponsor, hr) 
...
## Reflections
*FLASHING LIGHT AND MIRRORS AID IN CAMERA DETECTION*

- If you ever feel like, or are instructed to cover mirrors or `reflective` surfaces... `DONT`
- Cochleal implants with pond algae [(1)](https://share.google/aimode/VidtMXQk9nOLuGXuH) (cj final determinations viral piggyback research?) [(1)](https://1drv.ms/x/c/204c37d0ad34e8d9/IQBk2x1GhfYwRYVboMsMrAMaASk6Ev-qJo-tPTPL-vycF3c?e=ZOtvme), [(2)](./00_assets/science.adn0623_sm.pdf), [(3)](./00_assets/IMG_0101.jpg)
...
- Check with COC for FPD: BCF on 8/11/2026 **Note**: 8/11-8/13
